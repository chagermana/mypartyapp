...
class ShowerAdapter(private var mList: List<ShowerData>) :
    RecyclerView.Adapter<ShowerAdapter.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<ShowerData>) {
        this.mList = mList
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LanguageViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.each_item7, parent, false)
