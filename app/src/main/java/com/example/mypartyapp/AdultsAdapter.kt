...
class AdultsAdapter(private var mList: List<AdultsData>):
    RecyclerView.Adapter<AdultsAdapter.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<AdultsData>) {
        this.mList = mList
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LanguageViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.each_item5, parent, false)
